                                                                                                                                            ...
                                                                                                                                            : n.ast.kind == "=" && n.ast.l.ast.kind == "id" ? bindings_1.set_v(n.range, n.ast.l.ast.value, exports.ast_to_type_checker(n.ast.r)(context))
                                                                                                                                                : n.ast.kind == "=" && n.ast.l.ast.kind == "." && n.ast.l.ast.r.ast.kind == "id" ?
                                                                                                                                                    ...
                                                                                                                                                    : n.ast.kind == "cons_call" ?
                                                                                                                                                        bindings_1.call_cons(n.range, context, n.ast.type_args.length == 0 ? n.ast.name : n.ast.name + "<" + n.ast.type_args.map(function (a) { return types_1.type_to_string(ast_to_csharp_type(a)); }).reduce(function (a, b) { return a + "," + b; }) + ">", n.ast.actuals.map(function (a) { return exports.ast_to_type_checker(a)(context); }))
                                                                                                                                                                ...
                                                                                                                                                                : n.ast.kind == "class" && n.ast.generic_parameters.length == 0 ?
                                                                                                                                                                    bindings_1.def_class(n.range, n.ast.modifiers.toArray().map(function (m) { return m.kind; }), (n.ast.modifiers.toArray().some(function (m) { return m.kind == "abstract"; }) ? "abstract" :
                                                                                                                                                                        ...
                                                                                                                                                                        params_base_call: c.decl.params_base_call.kind == "left"
                                                                                                                                                                            ? ts_bccc_1.apply(ts_bccc_1.inl(), c.decl.params_base_call.value.map(function (e) { return exports.ast_to_type_checker(e)(context); }))
                                                                                                                                                                    ...
                                                                                                                                                                    : n.ast.kind == "class" && n.ast.generic_parameters.length > 0 && !n.ast.generic_parameters.some(function (p) { return p.name.ast.kind != "id"; }) ?
                                                                                                                                                                        bindings_1.def_generic_class(n.range, n.ast.C_name, n.ast.generic_parameters.map(function (p) { return ({ name: p.name.ast.kind == "id" ? p.name.ast.value : "_anonymous_type_parameter?", variance: p.variant }); }), function (generic_arguments) {
                                                                                                                                                                            // todo: return co_error if generic_arguments do not cover all names
                                                                                                                                                                            if (n.ast.kind != "class")
                                                                                                                                                                                return function (_) { return ts_bccc_1.co_error({ range: n.range, message: "Error: cannot instantiate " + n.ast + " as it is not a class" }); };
                                                                                                                                                                            var generic_params = n.ast.generic_parameters.map(function (p) { return p.name.ast.kind == "id" ? p.name.ast.value : "_anonymous_type_parameter?"; });
                                                                                                                                                                            var C_name = n.ast.C_name;
                                                                                                                                                                            var C_name_inst = C_name + "<" + generic_params.map(function (p) { return types_1.type_to_string(generic_arguments.get(p)); }).reduce(function (a, b) { return a + "," + b; }) + ">";
                                                                                                                                                                            console.log("Instantiating generic type " + n.ast.C_name + " into " + C_name_inst);
                                                                                                                                                                            return bindings_1.def_class(n.range, n.ast.modifiers.toArray().map(function (m) { return m.kind; }), (n.ast.modifiers.toArray().some(function (m) { return m.kind == "abstract"; }) ? "abstract" :
                                                                                                                                                                                n.ast.modifiers.toArray().some(function (m) { return m.kind == "interface"; }) ? "interface" : "normal"), C_name_inst, n.ast.extends_or_implements, n.ast.methods.toArray().map(function (m) { return function (context) { return ({
                                                                                                                                                                                name: m.decl.name,
                                                                                                                                                                                return_t: ast_to_csharp_type(m.decl.return_type),
                                                                                                                                                                                params_base_call: ts_bccc_1.apply(ts_bccc_1.inr(), {}),
                                                                                                                                                                                // todo: replace types
                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                    : n.ast.kind == "sprite" ?
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        : n.ast.kind == "other surface" ?
                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            : n.ast.kind == "filesystem+program" ?
                                                                                                                                                                                                                                                bindings_1.mk_filesystem_and_program(n.range, exports.ast_to_type_checker(n.ast.filesystem)(context), exports.ast_to_type_checker(n.ast.program)(context))
                                                                                                                                                                                                                                                : n.ast.kind == "filesystem" ?
                                                                                                                                                                                                                                                    bindings_1.mk_filesystem(n.range, n.ast.nodes.toArray().map(function (n) { return exports.ast_to_type_checker(n)(context); }))
                                                                                                                                                                                                                                                    : n.ast.kind == "filesystem.file" ?
                                                                                                                                                                                                                                                        bindings_1.mk_fs_file(n.range, exports.ast_to_type_checker(n.ast.path)(context), n.ast.attributes.toArray().map(function (n) { return exports.ast_to_type_checker(n)(context); }))
                                                                                                                                                                                                                                                        : n.ast.kind == "filesystem.keyvalue" ?
                                                                                                                                                                                                                                                            bindings_1.mk_fs_key_value(n.range, exports.ast_to_type_checker(n.ast.key)(context), exports.ast_to_type_checker(n.ast.value)(context))
                                                                                                                                                                                                                                                            : (function () {
