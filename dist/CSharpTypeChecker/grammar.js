...
exports.parser_or = function (p, q) {
    return ccc_aux_1.co_catch(primitives_1.merge_errors)(p)(q);
};
...
var expr_AUX = function (table, try_par) {
    var cases = function (l) {
        ...
        // to improve
        return exports.parser_or(index_of.then(function (index) { return expr_after_op(symbols, callables, table.ops, "[]", mk_unary(function (l, is_callable) { return ({ kind: "res", value: primitives_1.mk_get_array_value_at(source_range_1.mk_range(-1, -1, -1, -1), l, index) }); })); }), exports.parser_or(primitives_1.dot_sign.then(function (_) { return expr_after_op(symbols, callables, table.ops, ".", mk_binary(function (l, r) { return primitives_1.mk_field_ref(l, r); })); }), exports.parser_or(exports.par.then(function (actuals) {
            ...
            return expr_after_op(symbols, l != "none" ? callables.push(is_callable(l)) : callables, table.ops, "()", mk_unary(function (_l, is_callable) {
                return _l == "none" ? { kind: "0-ary_push_back", value: primitives_1.mk_bracket(actuals[0], source_range_1.mk_range(-1, -1, -1, -1)) }
                    : !is_callable ? { kind: "0-ary_push_back", value: primitives_1.mk_bracket(actuals[0], source_range_1.mk_range(-1, -1, -1, -1)) }
                        : { kind: "res", value: primitives_1.mk_call(_l, actuals) };
            }));
        }), exports.parser_or(comma.then(function (_) { return expr_after_op(symbols, callables, table.ops, ",", mk_binary(function (l, r) { return primitives_1.mk_pair(l, r); })); }), exports.parser_or(primitives_1.arrow_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "=>", mk_binary(function (l, r) {
            //console.log("mk_arrow-2", JSON.stringify(r)) || 
            return primitives_1.mk_arrow(l, r);
        })); }), exports.parser_or(primitives_1.plus_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "+", mk_binary(function (l, r) { return primitives_1.mk_plus(l, r); })); }), exports.parser_or(primitives_1.minus_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "-", mk_binary(function (l, r) { return primitives_1.mk_minus(l, r); })); }), exports.parser_or(primitives_1.times_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "*", mk_binary(function (l, r) { return primitives_1.mk_times(l, r); })); }), exports.parser_or(primitives_1.div_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "/", mk_binary(function (l, r) { return primitives_1.mk_div(l, r); })); }), exports.parser_or(primitives_1.mod_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "%", mk_binary(function (l, r) { return primitives_1.mk_mod(l, r); })); }), exports.parser_or(primitives_1.lt_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "<", mk_binary(function (l, r) { return primitives_1.mk_lt(l, r); })); }), exports.parser_or(primitives_1.gt_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, ">", mk_binary(function (l, r) { return primitives_1.mk_gt(l, r); })); }), exports.parser_or(primitives_1.leq_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "<=", mk_binary(function (l, r) { return primitives_1.mk_leq(l, r); })); }), exports.parser_or(primitives_1.geq_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, ">=", mk_binary(function (l, r) { return primitives_1.mk_geq(l, r); })); }), exports.parser_or(primitives_1.eq_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "==", mk_binary(function (l, r) { return primitives_1.mk_eq(l, r); })); }), exports.parser_or(primitives_1.neq_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "!=", mk_binary(function (l, r) { return primitives_1.mk_neq(l, r); })); }), exports.parser_or(primitives_1.and_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "&&", mk_binary(function (l, r) { return primitives_1.mk_and(l, r); })); }), exports.parser_or(primitives_1.or_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "||", mk_binary(function (l, r) { return primitives_1.mk_or(l, r); })); }), exports.parser_or(primitives_1.xor_op.then(function (_) { return expr_after_op(symbols, callables, table.ops, "xor", mk_binary(function (l, r) { return primitives_1.mk_xor(l, r); })); }), ts_bccc_1.co_unit(__assign({}, table, { symbols: symbols, callables: callables })))))))))))))))))))));
    };
    ...
    return exports.parser_or(primitives_1.term(try_par ? try_par : false).then(function (l) { return cases(l); }), cases("none"));
};
...
exports.expr = function () {
    ...
    return exports.parser_or(array_new(), exports.parser_or(cons_call(), res));
};
...
var type_args = function () {
    return exports.parser_or(type_decl().then(function (a) {
        return exports.parser_or(comma.then(function (_) {
...
var type_decl = function () {
    return exports.parser_or(primitives_1.left_bracket.then(function (lb) {
        return exports.parser_or(type_args().then(function (as) {
        ...
        return exports.parser_or(primitives_1.lt_op.then(function (_) {
            return partial_match.then(function (_) {
        ...
        }), exports.parser_or(primitives_1.left_square_bracket.then(function (_) {
            return partial_match.then(function (_) {
...
var actuals = function () {
    return exports.parser_or(exports.expr().then(function (a) {
        return exports.parser_or(comma.then(function (_) {
...
var arg_decls = function () {
    return exports.parser_or(decl().then(function (d) {
        return exports.parser_or(comma.then(function (_) {
...
var return_statement = function () {
    return no_match.then(function (_) {
        return primitives_1.return_sign.then(function (return_range) {
            return partial_match.then(function (_) {
                return exports.parser_or(exports.expr().then(function (e) {
            ...
            return partial_match.then(function (_) {
                return exports.expr().then(function (c) {
                    return stmt().then(function (t) {
                        return exports.parser_or(primitives_1.else_keyword.then(function (_) {
...
var outer_statement = function () {
    return exports.parser_or(function_declaration().then(function (fun_decl) {
    ...
    }), exports.parser_or(class_declaration(), inner_statement()));
};
...
var generic_statements = function (stmt, check_trailer) {
    return exports.parser_or(stmt().then(function (l) {
        return exports.parser_or(generic_statements(stmt, check_trailer).then(function (r) { return ts_bccc_1.co_unit(r.ast.kind == "noop" ? l : primitives_1.mk_semicolon(l, r)); }), check_trailer.then(function (_) { return ts_bccc_1.co_unit(l); }));
...
var modifier = function () {
    return exports.parser_or(primitives_1.private_modifier.then(function (r) { return ts_bccc_1.co_unit(primitives_1.mk_private(r)); }), exports.parser_or(primitives_1.public_modifier.then(function (r) { return ts_bccc_1.co_unit(primitives_1.mk_public(r)); }), exports.parser_or(primitives_1.protected_modifier.then(function (r) { return ts_bccc_1.co_unit(primitives_1.mk_protected(r)); }), exports.parser_or(primitives_1.virtual_modifier.then(function (r) { return ts_bccc_1.co_unit(primitives_1.mk_virtual(r)); }), exports.parser_or(primitives_1.override_modifier.then(function (r) { return ts_bccc_1.co_unit(primitives_1.mk_override(r)); }), primitives_1.static_modifier.then(function (r) { return ts_bccc_1.co_unit(primitives_1.mk_static(r)); }))))));
};
var modifiers = function () {
    return exports.parser_or(modifier().then(function (m) {
...
var class_statements = function () {
    return exports.parser_or(exports.parser_or(with_semicolon(modifiers().then(function (ms) { return decl().then(function (d) {
        return ts_bccc_1.co_unit(ts_bccc_1.apply(ts_bccc_1.inl(), { decl: d, modifiers: ms }));
    }); })), exports.parser_or(modifiers().then(function (ms) { return function_declaration().then(function (d) {
