...
(function (GrammarBasics) {
    ...
    var token = lex_catch(semicolon)(lex_catch(plus)(lex_catch(times)(lex_catch(dot)(lex_catch(lbr)(lex_catch(rbr)(lex_catch(int)(lex_catch(float)(lex_catch(_if)(lex_catch(_eq)(lex_catch(_then)(lex_catch(_else)(lex_catch(int)(lex_catch(identifier)(whitespace))))))))))))));
...
var whitespace = function () {
    return ccc_aux_1.co_repeat(ccc_aux_1.co_catch(fst_err)(newline_sign)(whitespace_sign));
}; //.then(_ => co_unit({}))
...
var term = function () {
    return ccc_aux_1.co_catch(both_errors)(identifier)(ccc_aux_1.co_catch(both_errors)(int)(left_bracket.then(function (_) {
