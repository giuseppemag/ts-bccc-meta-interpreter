...
var int = CSharp.def_class(source_range_1.minus_two_range, "int", [
    ...
    function (_) { return ({ modifiers: ["static", "public", "casting", "operator"], is_constructor: false, range: source_range_1.minus_two_range,
        ...
        body: from_js(CSharp.float_type, Sem.get_v_rt("a").then(function (a_v) {
...
exports.float = CSharp.def_class(source_range_1.minus_two_range, "float", [
    ...
    function (_) { return ({ modifiers: ["static", "public", "operator"], is_constructor: false, range: source_range_1.minus_two_range,
        ...
        body: from_js(CSharp.float_type, Sem.get_v_rt("a").then(function (a_v) { return Sem.get_v_rt("b").then(function (b_v) {
            return Sem.return_rt(Sem.float_expr(a_v.value.v + b_v.value.v));
        }); })) }); },
    function (_) { return ({ modifiers: ["static", "public", "operator"], is_constructor: false, range: source_range_1.minus_two_range,
        return_t: CSharp.float_type, name: "*", parameters: [{ name: "a", type: CSharp.float_type }, { name: "b", type: CSharp.float_type }],
        body: from_js(CSharp.float_type, Sem.get_v_rt("a").then(function (a_v) { return Sem.get_v_rt("b").then(function (b_v) {
...
exports.double = CSharp.def_class(source_range_1.minus_two_range, "double", [
    ...
    function (_) { return ({ modifiers: ["static", "public", "operator"], is_constructor: false, range: source_range_1.minus_two_range,
        ...
        body: from_js(CSharp.double_type, Sem.get_v_rt("a").then(function (a_v) { return Sem.get_v_rt("b").then(function (b_v) {
            return Sem.return_rt(Sem.float_expr(a_v.value.v + b_v.value.v));
        }); })) }); },
    function (_) { return ({ modifiers: ["static", "public", "operator"], is_constructor: false, range: source_range_1.minus_two_range,
        return_t: CSharp.double_type, name: "*", parameters: [{ name: "a", type: CSharp.double_type }, { name: "b", type: CSharp.double_type }],
...
exports.standard_lib = function () { return CSharp.semicolon(source_range_1.minus_two_range, int, CSharp.semicolon(source_range_1.minus_two_range, exports.float, CSharp.semicolon(source_range_1.minus_two_range, exports.double, math))); };
