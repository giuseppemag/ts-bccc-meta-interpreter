...
export declare const mk_decl_and_init: (l: ParserRes, r: string, v: ParserRes, r_range: SourceRange) => DeclAndInitAST;
export declare const mk_decl: (l: ParserRes, r: string, r_range: SourceRange) => DeclAST;
