<<<<<<< 629345f0ceb9c8a5a8755fd88f165862aa443851
"use strict";
        ...
        return set_bindings(exports.no_constraints).then(function (_) {
            return body(exports.no_constraints).then(function (body_t) {
                return type_equals(body_t.type, return_t) ?
                    Co.co_set_state(initial_bindings).then(function (_) {
                        return is_static ?
                            ts_bccc_2.co_unit(mk_typing(exports.fun_type(exports.tuple_type(parameters.map(function (p) { return p.type; })), body_t.type), Sem.mk_lambda_rt(body_t.sem, parameters.map(function (p) { return p.name; }), [], def.range)))
                            : ts_bccc_2.co_unit(mk_typing(exports.fun_type(exports.tuple_type([exports.ref_type(C_name)]), exports.fun_type(exports.tuple_type(parameters.map(function (p) { return p.type; })), body_t.type)), Sem.mk_lambda_rt(Sem.mk_lambda_rt(body_t.sem, parameters.map(function (p) { return p.name; }), ["this"], def.range), ["this"], [], def.range)));
                    })
                    : ts_bccc_2.co_error({ range: r, message: "Error: return type does not match declaration" });
            });
        });
    ...
    return function (_) { return this_ref(exports.no_constraints).then(function (this_ref_t) {
        return ts_bccc_1.co_get_state().then(function (bindings) {
            if (this_ref_t.type.kind != "ref" && this_ref_t.type.kind != "obj") {
                ...
                if (this_ref_t.type.kind == "tuple" && m != null && m.length != 0) {
                    ...
                    if (this_ref_t.type.kind == "record" && this_ref_t.type.args.has(F_or_M_name)) {
                        try {
                            return ts_bccc_2.co_unit(mk_typing(this_ref_t.type.args.get(F_or_M_name), Sem.record_get_rt(r, this_ref_t.sem, F_or_M_name)));
                        }
                        catch (error) {
                            return ts_bccc_2.co_error({ range: r, message: "Invalid field getter " + F_or_M_name + "." });
                        }
            ...
            if (C_def.fields.has(F_or_M_name)) {
                ...
                return ts_bccc_2.co_unit(mk_typing(M_def.modifiers.has("static") ? M_def.typing.type : M_def.typing.type.out, M_def.modifiers.has("static") ?
