...
exports.mk_generic_type_inst = function (r, f, args) {
    return ({ range: r, ast: { kind: "generic type inst", f: f, args: args } });
};
...
exports.mk_abstract = function (sr) { return ({ range: sr, ast: { kind: "abstract" } }); };
exports.mk_interface = function (sr) { return ({ range: sr, ast: { kind: "interface" } }); };
...
exports.filesystem_keyword = exports.symbol("filesystem", "filesystem");
exports.file_keyword = exports.symbol("fsfile", "fsfile");
...
exports.abstract_modifier = exports.symbol("abstract", "abstract");
exports.interface_modifier = exports.symbol("interface", "interface");
