...
run_checks([
    ...
    },
    {
        ...
        checks: [
            ...
            { name: "function scope cleaned up", step: 3, expected_kind: "bindings", check: function (s) { return s.has("factorial") && s.has("x") && !s.has("res"); } },
    ...
    },
    {
        ...
        checks: [
            ...
            { name: "y is result", step: 5, expected_kind: "memory", check: function (s) { return assert_equal(s.globals.get(0).get("y").v, 1 * 4 * 4 + 2 * 4 + 3); } },
        ]
    },
    {
        name: "Vector2",
