...
(function (ImpLanguageWithSuspend) {
    ...
    ImpLanguageWithSuspend.test_imp = function () {
        ...
        var fun_test = CSharp.semicolon(CSharp.decl_v("x", CSharp.int_type), CSharp.semicolon(CSharp.decl_v("y", CSharp.int_type), CSharp.semicolon(CSharp.set_v("x", CSharp.int(2)), CSharp.semicolon(CSharp.set_v("y", CSharp.int(5)), CSharp.semicolon(CSharp.def_fun("f", (CSharp.ret(CSharp.plus(CSharp.get_v("i"), CSharp.get_v("x")))), [CSharp.mk_param("i", CSharp.int_type)], ["x"]), CSharp.semicolon(CSharp.def_fun("g", (CSharp.ret(CSharp.times(CSharp.get_v("j"), CSharp.get_v("x")))), [CSharp.mk_param("j", CSharp.int_type)], ["x"]), CSharp.semicolon(CSharp.breakpoint(source_range_1.mk_range(3, 3, 3, 3))(CSharp.done), CSharp.semicolon(CSharp.set_v("x", CSharp.call_by_name("f", [CSharp.get_v("y")])), CSharp.semicolon(CSharp.breakpoint(source_range_1.mk_range(4, 4, 4, 4))(CSharp.done), CSharp.set_v("x", CSharp.call_by_name("g", [CSharp.get_v("y")])))))))))));
