...
export declare let mk_lambda_rt: (body: ExprRt<Val>, parameters: string[], closure_parameters: string[], range: SourceRange) => ExprRt<Val>;
export declare let def_fun_rt: (n: string, body: ExprRt<Val>, parameters: string[], closure_parameters: string[], range: SourceRange) => ExprRt<Val>;
