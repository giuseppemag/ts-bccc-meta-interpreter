...
export declare let declare_class: (C_name: string, int: Interface) => Expr<Val>;
export declare let field_get: (F_name: string, this_addr: HeapRef) => Expr<Val>;
export declare let field_set: (F_name: string, new_val_expr: Expr<Val>, this_addr: HeapRef) => Expr<Val>;
