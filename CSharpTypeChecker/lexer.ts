...
export type ReservedKeyword = "interface"|"abstract"|"base"|"for"|"while"|"if"|"then"|"else"|"private"|"public"|"static"|"protected"|"virtual"|"override"|"class"|"new"|"debugger"|"typechecker_debugger"|"return"|"?"|":"|"filesystem"|"fsfile"
...
export module GrammarBasics {
  ...
  let token:Lexer = lex_catch_many(Immutable.List<Lexer>([
    ...
    parse_prefix_regex(/^[a-zA-Z_][a-zA-Z0-9_]*/, (s,r) =>
      ...
      || s == "static" || s == "filesystem" || s == "fsfile" ? ({range:r, kind:s as ReservedKeyword})
