...
export let field_get_rt = function(F_name:ValueName, this_addr:HeapRef) : ExprRt<Val> {
...
export let field_get_expr_rt = function(F_name:ValueName, this_expr:ExprRt<Val>) : ExprRt<Val> {
  return this_expr.then(this_addr =>
    this_addr.k != "ref" ? runtime_error(`runtime type error`) :
    field_get_rt(F_name, this_addr))
}

export let field_set_rt = function(F_name:ValueName, new_val_expr:ExprRt<Val>, this_addr:HeapRef) : StmtRt {
...
export let field_set_expr_rt = function(F_name:ValueName, new_val_expr:ExprRt<Val>, this_expr:ExprRt<Val>) : StmtRt {
  return this_expr.then(this_addr =>
    this_addr.k != "ref" ? runtime_error(`runtime type error`) :
...
export let call_method_rt = function(M_name:ValueName, this_addr:Val, args:Array<ExprRt<Val>>) : ExprRt<Val> {
...
export let call_method_expr_rt = function(M_name:ValueName, this_expr:ExprRt<Val>, args:Array<ExprRt<Val>>) : ExprRt<Val> {
  return this_expr.then(this_addr => call_method_rt(M_name, this_addr, args))
}

export let call_cons_rt = function(C_name:ValueName, args:Array<ExprRt<Val>>) : ExprRt<Val> {
